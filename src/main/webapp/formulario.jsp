...
<jsp:include page="includes/cabecera.jsp" />
		...
		<form method="post" action="perro-controller">
			...
			<div class="form-group">
				...
				<input type="checkbox" id="vacunado" class="w-6" name="vacunado" checked>
			</div>
			
			<div class="form-group">
				<label for="historia">Historia</label>
				<textarea id="historia" name="historia" cols="42" rows="5" placeholder="Cuentame la historia del perro"></textarea>	
			</div>
